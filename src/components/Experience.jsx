...
const TagCard = ({ number, title, text, className, aosDelay, aosType, pathLength, containerRef }) => {
  ...
  return (
    ...
    >
      ...
      <div className={`w-full h-full rounded-[1.5rem] mt-8 p-8 flex flex-col min-h-[300px] transition-colors duration-700 ${
        ...
        <div className={`text-xs font-bold mb-4 transition-colors duration-700 ${
          isActive ? 'text-red-200' : 'text-gray-500'
        }`} dangerouslySetInnerHTML={{ __html: text.split('<br/>')[0] }} />

        <ul className={`text-sm leading-relaxed font-medium transition-colors duration-700 list-disc pl-4 space-y-1 ${
          isActive ? 'text-red-100' : 'text-gray-600'
        }`}>
          {text.split('<br/>').slice(1).map((item, idx) => (
      ...
      <div className="max-w-6xl mx-auto relative md:h-[1350px]">
        ...
        <div data-aos="fade-up" className="md:absolute top-10 left-0 md:w-[450px] z-20 mb-16 md:mb-0">
          ...
          <p className="text-gray-500 text-base md:text-lg max-w-sm font-medium leading-relaxed">
            Building AI-powered products, research systems, and intelligent automation pipelines.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-8 md:gap-12 items-center md:block relative z-10 w-full pt-4 md:pt-0 pb-12 md:pb-0">
          ...
          <TagCard 
            number="01"
            title="AI Research & Dev Intern"
            text="Nexus AI Data Labs | Nov 2025 – Apr 2026<br/>- Built LLM-powered automation pipelines for enterprise AI trend analysis.<br/>- Developed research automation systems using OpenAI APIs.<br/>- Created AI-powered web scraping and information synthesis workflows.<br/>- Improved research productivity using Generative AI and model optimization techniques."
          ...
          <TagCard 
            ...
            text="CAR XSTREAME | Oct 2024 – Nov 2024<br/>- Built a GenAI chatbot using OpenAI APIs.<br/>- Implemented adversarial input prevention mechanisms.<br/>- Automated contextual data scraping.<br/>- Improved chatbot performance using prompt engineering and fine-tuning strategies."
          ...
          <TagCard 
            ...
            text="KIDZIAN | Sep 2024 – Nov 2024<br/>- Designed OpenCV-based educational applications.<br/>- Built AI-powered learning tools.<br/>- Developed real-time AI modules for educational platforms."
          ...
          <TagCard 
            ...
            text="EVOASTRA | Jun 2024 – Aug 2024<br/>- Developed 5 machine learning pipelines using Random Forest.<br/>- Built vehicle price prediction systems.<br/>- Performed feature engineering and feature selection.<br/>- Improved model accuracy and processing efficiency."
